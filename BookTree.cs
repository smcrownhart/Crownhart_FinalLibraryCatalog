...
{
 //Orginally I started searching by ISBN but that was creating all kinds of problems.
 //That's why there's a unique identifier in the book class to search by in here. 
 //That was ChatGPT's suggestion to get it to work hopefully correctly.
